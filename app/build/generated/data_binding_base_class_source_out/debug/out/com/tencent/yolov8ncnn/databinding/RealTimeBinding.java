...
public final class RealTimeBinding implements ViewBinding {
  @NonNull
  ...
  private RealTimeBinding(@NonNull LinearLayout rootView, @NonNull Button buttonSwitchCamera,
  ...
  @NonNull
  public static RealTimeBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RealTimeBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.real_time, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RealTimeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RealTimeBinding((LinearLayout) rootView, buttonSwitchCamera, cameraview,
